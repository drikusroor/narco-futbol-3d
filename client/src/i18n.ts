...
const en = {
  ...
  'menu.credits': 'Arcade football. Fictional clubs, fictional sponsors, fictional everything.',
  ...
  'settings.rebind': 'Click a key to change it. Esc clears it.',
  'settings.listening': 'press a key…',
  'settings.reset': 'RESTORE DEFAULTS',
  'settings.close': 'CLOSE',
  'settings.leave': 'LEAVE THE PITCH',
  'settings.gamepad': 'Gamepad: left stick move, A pass, B shoot, Y lob, X tackle, RB sprint, LB switch.',
  'action.up': 'Move up',
...
const es: Record<Key, string> = {
  ...
  'menu.credits': 'Fútbol arcade. Clubes ficticios, patrocinadores ficticios, todo ficticio.',
  ...
  'settings.rebind': 'Hacé clic en una tecla para cambiarla. Esc la borra.',
  'settings.listening': 'apretá una tecla…',
  'settings.reset': 'VALORES POR DEFECTO',
  'settings.close': 'CERRAR',
  'settings.leave': 'SALIR DE LA CANCHA',
  'settings.gamepad': 'Joystick: stick izquierdo mover, A pase, B remate, Y globo, X quite, RB sprint, LB cambiar.',
