...
const en = {
  ...
  'menu.mode.solo': 'Solo (this device)',
  'menu.mode.coop': 'Local 2P (this device)',
  'menu.mode.onlineDisabled': 'This is a static build with no game server — online play, training and the tutorial are unavailable here. Play solo or local 2P instead.',
  'menu.mode.localNote': 'Player 1: keyboard/pad as usual. Player 2: arrow keys to move, Enter pass, \' shoot, ; lob, right‑Shift sprint, / tackle, ] switch — or a second gamepad.',
  'menu.mode.player2': 'Player 2',
  'menu.team': 'Team',
  'menu.team.auto': 'Auto',
  'menu.length': 'Length',
  'menu.size': 'Squads',
...
const es: Record<Key, string> = {
  ...
  'menu.room.ph': 'estadio',
  'menu.mode': 'Modo',
  'menu.mode.online': 'En línea',
  'menu.mode.solo': 'Solo (este dispositivo)',
  'menu.mode.coop': '2 jugadores local (este dispositivo)',
  'menu.mode.onlineDisabled': 'Esta versión estática no tiene servidor de juego — el modo en línea, el entrenamiento y el tutorial no están disponibles aquí. Juega solo o local a dos.',
  'menu.mode.localNote': 'Jugador 1: teclado/mando de siempre. Jugador 2: flechas para moverse, Enter pase, \' disparo, ; globo, Shift derecho sprint, / entrada, ] cambiar — o un segundo mando.',
  'menu.mode.player2': 'Jugador 2',
  'menu.team': 'Equipo',
  'menu.team.auto': 'Auto',
